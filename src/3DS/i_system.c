 ...
 *
 * DESCRIPTION:
 *  Misc system stuff needed by Doom, implemented for 3DS.
...
{
  snprintf(buf,sz,"%s v%s\nhttp://github.com/devinacker/prboom-3ds",PACKAGE,VERSION);
  return buf;
}
...
{
	// lprintf(LO_INFO, "I_SetAffinityMask: not implemented\n");
}
